...
(function(theme, $) {
	...
	var Skeleton = {
		...
		build: function() {
			...
			$html.addClass( 'custom-scroll sidebar-left-collapsed' );
...
(function( $ ) {
	...
	$(function() {
		$('.panel')
			.on( 'click', '.panel-heading.panel-heading-toggelable', function( e ) {
				e.preventDefault();
				e.stopPropagation();
				...
				$actionOpen = $this.find( '.panel-actions a.fa-caret-up' );
				$actionClose = $this.find( '.panel-actions a.fa-caret-down' );
